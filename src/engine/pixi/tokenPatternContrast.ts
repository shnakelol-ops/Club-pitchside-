...
export function resolvePatternMarkColor(base: string, secondary: string, pattern: TacticalKitPattern | string): string {
...
export function resolvePatternDetailTier(pattern: TacticalKitPattern | string, radius: number): 0 | 1 | 2 {
