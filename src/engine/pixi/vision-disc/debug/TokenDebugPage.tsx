...
import { createTokenDebugSurface } from "./createTokenDebugSurface";
import type { TokenDebugView } from "./tokenDebugTypes";
import "./tokenDebugPage.css";

function sanitizeView(value: string | null): TokenDebugView {
...
export default function TokenDebugPage() {
  ...
  return (
    <main className="token-debug-page">
      <section className="token-debug-shell" aria-label="VisionDisc token renderer debug comparison">
        <div className="token-debug-route-note">
          <strong>/token-debug</strong>
          <span>Debug-only renderer experiment. No production token wiring.</span>
