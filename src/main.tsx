...
import MovementFoundationSandboxPage from "./pages/MovementFoundationSandboxPage";
...
const MOVEMENT_FOUNDATION_SANDBOX_PATH = "/movement-foundation-sandbox";
...
function pickRootComponent() {
  ...
  if (normalizedPath === MOVEMENT_FOUNDATION_SANDBOX_PATH) {
    return MovementFoundationSandboxPage;
  }
  return redirectToBoard();
}
