...
} from "../../tactical-lite/pixi/renderQuickBoardPitch";
import {
  NORMALIZED_MAX,
  NORMALIZED_MIN,
...
export type TacticalPadLiteSurface = QuickBoardSurface;
...
export async function createQuickBoardSurface(
  host: HTMLElement,
  options: TacticalPadLiteSurfaceOptions = {},
): Promise<QuickBoardSurface> {
...
export async function createTacticalPadLiteSurface(
  ...
  return createQuickBoardSurface(host, options);
}
