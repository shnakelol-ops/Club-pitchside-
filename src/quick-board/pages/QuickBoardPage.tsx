...
import {
  createQuickBoardSurface,
  type ItemMode,
  type QuickBoardSurface,
  type TacticalItem,
  type WhiteboardTokenColor,
} from "../engine/pixi/createQuickBoardSurface";
import StatsModeSurface from "../../StatsModeSurface";
import OrientationGate from "../components/QuickBoardOrientationGate";
...
export default function QuickBoardPage({ initialMode = "tactical" }: TacticalPadLiteCleanProps) {
  const hostRef = useRef<HTMLDivElement | null>(null);
  const surfaceRef = useRef<QuickBoardSurface | null>(null);
  ...
  useEffect(() => {
    ...
    void createQuickBoardSurface(host, {
