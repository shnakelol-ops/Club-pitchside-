...
function buildGaelicFootballLandscapeMarkings(): PitchMarking[] {
  ...
  const twoPointArc = Math.PI * 0.372;
  ...
  return [
    ...
    { kind: "ellipseArc", cx: x20L, cy, rx: rx40, ry: ry40, startAngle: -twoPointArc, endAngle: twoPointArc, stroke: Lg.lineGridStrong, strokeWidth: w2Point, strokeLinecap: "round" },
    { kind: "ellipseArc", cx: x20R, cy, rx: rx40, ry: ry40, startAngle: Math.PI - twoPointArc, endAngle: Math.PI + twoPointArc, stroke: Lg.lineGridStrong, strokeWidth: w2Point, strokeLinecap: "round" },
    { kind: "ellipseArc", cx: x20L, cy, rx: rxD, ry: ryD, startAngle: dArcStart, endAngle: dArcEnd, stroke: Lg.lineGridStrong, strokeWidth: wD, strokeLinecap: "butt" },
    { kind: "ellipseArc", cx: x20R, cy, rx: rxD, ry: ryD, startAngle: Math.PI - dArcEnd, endAngle: Math.PI - dArcStart, stroke: Lg.lineGridStrong, strokeWidth: wD, strokeLinecap: "butt" },
  ];
}
