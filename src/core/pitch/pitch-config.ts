...
function buildGaelicFootballLandscapeMarkings(): PitchMarking[] {
  ...
  return [
    ...
    { kind: "ellipseArc", cx: x20L, cy, rx: rxD, ry: ryD, startAngle: dArcStart, endAngle: dArcEnd, stroke: Lg.lineGridStrong, strokeWidth: wD, strokeLinecap: "round" },
    { kind: "ellipseArc", cx: x20R, cy, rx: rxD, ry: ryD, startAngle: Math.PI - dArcEnd, endAngle: Math.PI - dArcStart, stroke: Lg.lineGridStrong, strokeWidth: wD, strokeLinecap: "round" },
  ];
}
