...
function createGaelicStripeTileTexture(
...
export class GaelicPitchRenderer {
  ...
  private build(sport: Extract<PitchSport, "gaelic" | "hurling">): void {
    ...
    const stripeParams = gaelicStripeTilingParams(sport);
...
export function createGaelicPitchMount(
  sport: Extract<PitchSport, "gaelic" | "hurling">,
): GaelicPitchMount {
  return mountGaelicPitchRenderer(sport);
}
